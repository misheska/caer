...
namespace caer {
    ...
    public:
        ...
        _ConfigOption(const std::string& description_,
                      _VariantType initValue_,
                      const _ConfigAttributes<V> &attributes_) : description(description_), initValue(initValue_), attributes(attributes_) {}
    };
    ...
    private:
        ...
        static ConfigOption getOption(const std::string& description,
                                      typename _ConfigVariantType<V>::type defaultValue,
                                      const _ConfigAttributes<V> &attributes_) {
            return ConfigOption(std::shared_ptr<_ConfigOption<V>>(
                    new _ConfigOption<V>(description, defaultValue, attributes_)), V);
        }
    ...
    public:
         ...
         */
        template <_ConfigVariant V>
        _ConfigOption<V>& getConfigObject() {
    ...
    public:
         ...
         */
        template <_ConfigVariant V>
        const typename _ConfigVariantType<V>::type get(const std::string &key) {
