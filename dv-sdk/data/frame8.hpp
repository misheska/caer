...
#ifndef FLATBUFFERS_GENERATED_FRAME8_DV_H_
#define FLATBUFFERS_GENERATED_FRAME8_DV_H_
...
inline flatbuffers::Offset<Frame8> CreateFrame8Direct(flatbuffers::FlatBufferBuilder &_fbb, int64_t timestamp = 0,
	...
	return dv::CreateFrame8(_fbb, timestamp, timestampStartOfFrame, timestampEndOfFrame, timestampStartOfExposure,
...
inline flatbuffers::Offset<Frame8> CreateFrame8(
	...
	return dv::CreateFrame8(_fbb, _timestamp, _timestampStartOfFrame, _timestampEndOfFrame, _timestampStartOfExposure,
...
inline const dv::Frame8 *GetFrame8(const void *buf) {
	return flatbuffers::GetRoot<dv::Frame8>(buf);
}

inline const dv::Frame8 *GetSizePrefixedFrame8(const void *buf) {
	return flatbuffers::GetSizePrefixedRoot<dv::Frame8>(buf);
}

inline const char *Frame8Identifier() {
	return "FRM8";
}

const char *Frame8::identifier = Frame8Identifier();

inline bool Frame8BufferHasIdentifier(const void *buf) {
	return flatbuffers::BufferHasIdentifier(buf, Frame8Identifier());
}

inline bool VerifyFrame8Buffer(flatbuffers::Verifier &verifier) {
	return verifier.VerifyBuffer<dv::Frame8>(Frame8Identifier());
}

inline bool VerifySizePrefixedFrame8Buffer(flatbuffers::Verifier &verifier) {
	return verifier.VerifySizePrefixedBuffer<dv::Frame8>(Frame8Identifier());
}

inline void FinishFrame8Buffer(flatbuffers::FlatBufferBuilder &fbb, flatbuffers::Offset<dv::Frame8> root) {
	fbb.Finish(root, Frame8Identifier());
}

inline void FinishSizePrefixedFrame8Buffer(flatbuffers::FlatBufferBuilder &fbb, flatbuffers::Offset<dv::Frame8> root) {
	fbb.FinishSizePrefixed(root, Frame8Identifier());
}

inline std::unique_ptr<Frame8T> UnPackFrame8(const void *buf, const flatbuffers::resolver_function_t *res = nullptr) {
	return std::unique_ptr<Frame8T>(GetFrame8(buf)->UnPack(res));
}

} // namespace dv

#endif // FLATBUFFERS_GENERATED_FRAME8_DV_H_
