...
inline const FrameChannels (&EnumValuesFrameChannels())[3] {
  static const FrameChannels values[] = {
    FrameChannels::GRAYSCALE,
    FrameChannels::RGB,
    FrameChannels::RGBA
  };
  return values;
...
inline const FrameColorFilters (&EnumValuesFrameColorFilters())[9] {
  static const FrameColorFilters values[] = {
    FrameColorFilters::MONO,
    FrameColorFilters::RGBG,
    FrameColorFilters::GRGB,
    FrameColorFilters::GBGR,
    FrameColorFilters::BGRG,
    FrameColorFilters::RGBW,
    FrameColorFilters::GRWB,
    FrameColorFilters::WBGR,
    FrameColorFilters::BWRG
  };
  return values;
}
...
struct Frame8 FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<int8_t>(verifier, VT_NUMCHANNELS) &&
           VerifyField<int8_t>(verifier, VT_ORIGCOLORFILTER) &&
           VerifyField<int16_t>(verifier, VT_LENGTHX) &&
           VerifyField<int16_t>(verifier, VT_LENGTHY) &&
           VerifyField<int16_t>(verifier, VT_POSITIONX) &&
           VerifyField<int16_t>(verifier, VT_POSITIONY) &&
  ...
  static flatbuffers::Offset<Frame8> Pack(flatbuffers::FlatBufferBuilder &_fbb, const Frame8T* _o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);
};
...
struct Frame8Builder {
  ...
  explicit Frame8Builder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
...
inline flatbuffers::Offset<Frame8> CreateFrame8(
    ...
    FrameChannels numChannels = FrameChannels::GRAYSCALE,
    FrameColorFilters origColorFilter = FrameColorFilters::MONO,
    int16_t lengthX = 0,
    int16_t lengthY = 0,
    int16_t positionX = 0,
    int16_t positionY = 0,
...
inline flatbuffers::Offset<Frame8> CreateFrame8Direct(
    flatbuffers::FlatBufferBuilder &_fbb,
    int64_t timestamp = 0,
    int64_t timestampStartOfFrame = 0,
    int64_t timestampEndOfFrame = 0,
...
flatbuffers::Offset<Frame8> CreateFrame8(flatbuffers::FlatBufferBuilder &_fbb, const Frame8T *_o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);
...
struct Frame8Packet FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static flatbuffers::Offset<Frame8Packet> Pack(flatbuffers::FlatBufferBuilder &_fbb, const Frame8PacketT* _o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);
};
...
struct Frame8PacketBuilder {
  ...
  explicit Frame8PacketBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
inline flatbuffers::Offset<Frame8Packet> CreateFrame8PacketDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<flatbuffers::Offset<Frame8>> *events = nullptr) {
  return CreateFrame8Packet(
      _fbb,
      events ? _fbb.CreateVector<flatbuffers::Offset<Frame8>>(*events) : 0);
}

flatbuffers::Offset<Frame8Packet> CreateFrame8Packet(flatbuffers::FlatBufferBuilder &_fbb, const Frame8PacketT *_o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);
...
inline void Frame8::UnPackTo(Frame8T *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = timestampStartOfFrame(); _o->timestampStartOfFrame = _e; };
  { auto _e = timestampEndOfFrame(); _o->timestampEndOfFrame = _e; };
  { auto _e = timestampStartOfExposure(); _o->timestampStartOfExposure = _e; };
  { auto _e = timestampEndOfExposure(); _o->timestampEndOfExposure = _e; };
  { auto _e = numChannels(); _o->numChannels = _e; };
  { auto _e = origColorFilter(); _o->origColorFilter = _e; };
  { auto _e = lengthX(); _o->lengthX = _e; };
  { auto _e = lengthY(); _o->lengthY = _e; };
  { auto _e = positionX(); _o->positionX = _e; };
  { auto _e = positionY(); _o->positionY = _e; };
  { auto _e = pixels(); if (_e) { _o->pixels.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->pixels[_i] = _e->Get(_i); } } };
}

inline flatbuffers::Offset<Frame8> Frame8::Pack(flatbuffers::FlatBufferBuilder &_fbb, const Frame8T* _o, const flatbuffers::rehasher_function_t *_rehasher) {
  return CreateFrame8(_fbb, _o, _rehasher);
}

inline flatbuffers::Offset<Frame8> CreateFrame8(flatbuffers::FlatBufferBuilder &_fbb, const Frame8T *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const Frame8T* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline void Frame8Packet::UnPackTo(Frame8PacketT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = events(); if (_e) { _o->events.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->events[_i] = std::unique_ptr<Frame8T>(_e->Get(_i)->UnPack(_resolver)); } } };
}

inline flatbuffers::Offset<Frame8Packet> Frame8Packet::Pack(flatbuffers::FlatBufferBuilder &_fbb, const Frame8PacketT* _o, const flatbuffers::rehasher_function_t *_rehasher) {
  return CreateFrame8Packet(_fbb, _o, _rehasher);
}

inline flatbuffers::Offset<Frame8Packet> CreateFrame8Packet(flatbuffers::FlatBufferBuilder &_fbb, const Frame8PacketT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const Frame8PacketT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _events = _o->events.size() ? _fbb.CreateVector<flatbuffers::Offset<Frame8>> (_o->events.size(), [](size_t i, _VectorArgs *__va) { return CreateFrame8(*__va->__fbb, __va->__o->events[i].get(), __va->__rehasher); }, &_va ) : 0;
  return CreateFrame8Packet(
      _fbb,
      _events);
}
...
inline bool Frame8PacketBufferHasIdentifier(const void *buf) {
  return flatbuffers::BufferHasIdentifier(
      buf, Frame8PacketIdentifier());
}

inline bool VerifyFrame8PacketBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Frame8Packet>(Frame8PacketIdentifier());
}

inline bool VerifySizePrefixedFrame8PacketBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Frame8Packet>(Frame8PacketIdentifier());
}

inline void FinishFrame8PacketBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<Frame8Packet> root) {
