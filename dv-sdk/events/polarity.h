...
struct PolarityPacket FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  static flatbuffers::Offset<PolarityPacket> Pack(flatbuffers::FlatBufferBuilder &_fbb, const PolarityPacketT* _o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);
};
...
struct PolarityPacketBuilder {
  ...
  explicit PolarityPacketBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
...
inline flatbuffers::Offset<PolarityPacket> CreatePolarityPacket(
    ...
    flatbuffers::Offset<flatbuffers::Vector<const PolarityEvent *>> events = 0) {
...
inline flatbuffers::Offset<PolarityPacket> CreatePolarityPacketDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<PolarityEvent> *events = nullptr) {
  return CreatePolarityPacket(
      _fbb,
      events ? _fbb.CreateVectorOfStructs<PolarityEvent>(*events) : 0);
}

flatbuffers::Offset<PolarityPacket> CreatePolarityPacket(flatbuffers::FlatBufferBuilder &_fbb, const PolarityPacketT *_o, const flatbuffers::rehasher_function_t *_rehasher = nullptr);
...
inline void PolarityPacket::UnPackTo(PolarityPacketT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = events(); if (_e) { _o->events.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->events[_i] = *_e->Get(_i); } } };
}

inline flatbuffers::Offset<PolarityPacket> PolarityPacket::Pack(flatbuffers::FlatBufferBuilder &_fbb, const PolarityPacketT* _o, const flatbuffers::rehasher_function_t *_rehasher) {
  return CreatePolarityPacket(_fbb, _o, _rehasher);
}

inline flatbuffers::Offset<PolarityPacket> CreatePolarityPacket(flatbuffers::FlatBufferBuilder &_fbb, const PolarityPacketT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const PolarityPacketT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline const PolarityPacket *GetPolarityPacket(const void *buf) {
  return flatbuffers::GetRoot<PolarityPacket>(buf);
}

inline const PolarityPacket *GetSizePrefixedPolarityPacket(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<PolarityPacket>(buf);
}
...
inline bool PolarityPacketBufferHasIdentifier(const void *buf) {
  return flatbuffers::BufferHasIdentifier(
      buf, PolarityPacketIdentifier());
}

inline bool VerifyPolarityPacketBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<PolarityPacket>(PolarityPacketIdentifier());
}

inline bool VerifySizePrefixedPolarityPacketBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<PolarityPacket>(PolarityPacketIdentifier());
}

inline void FinishPolarityPacketBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<PolarityPacket> root) {
