...
inline void FinishPolarityPacketBuffer(flatbuffers::FlatBufferBuilder &fbb, flatbuffers::Offset<PolarityPacket> root) {
	fbb.Finish(root, PolarityPacketIdentifier());
}

inline void FinishSizePrefixedPolarityPacketBuffer(
	flatbuffers::FlatBufferBuilder &fbb, flatbuffers::Offset<PolarityPacket> root) {
